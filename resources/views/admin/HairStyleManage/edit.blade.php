    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
          <div>
            <form action="{{ url('/admin/hair-style-update/'.$hair->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="mb-4">
                ...
                <div class="flex gap-4 mt-4">
                  @foreach($hair->images as $image)
                    <div>
                      ...
                      <img src="/hair_style_image/{{$image->image}}" alt="image"
                      ...
                      <div class="bg-red-200 px-3 py-2 rounded-md text-center mt-3">
                        <a href="/admin/image-style-remove/{{$image->id}}">ลบภาพ</a>
                      </div>
                    </div>
                  @endforeach
                </div>
