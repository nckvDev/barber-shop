    ...
    <div class="mx-auto sm:px-6 lg:px-8 ">
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
          ...
          <div>
            <div class="mb-4">
              <a href="{{ route('admin.add-hair-products') }}"
...
{{--                  </td>--}}
                  ...
                  <td class=" px-6 py-4">
                    <div class="w-max">
                      <a href="{{ url('/admin/hair-products-edit/'.$hair->id) }}"
                      ...
                      <a href="{{ url('/admin/hair-products-delete/'.$hair->id) }}" class="text-white font-semibold bg-red-600 rounded-md px-2 py-1 border hover:bg-red-900 transition delete-confirm">ลบ</a>
                    </div>
                  </td>
                </tr>
              @empty
